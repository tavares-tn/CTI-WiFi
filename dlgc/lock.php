...
<html lang="en-us">
	<head>
		...
		<title> Linux Fácil </title>
		<meta name="description" content="Login">
		<meta name="author" content="Renato Azevedo">
	...
	<body>
		...
		<div id="main" role="main">
			...
			<form class="lockscreen animated flipInY" action="index.php">
				<div class="logo">
					<h1 class="semi-bold"><img src="img/logo-o.png" alt="" /> Linux Fácil</h1>
				</div>
				<div>
