<html>
<head>
<title>Cadastrar novo Usuário Default</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para cadastrar usuários default, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Usuários Default Cadastrados</b></td>';

//NOVO METODO PARA CONTAR    
$arquivo = "$user_acesso_especial";
