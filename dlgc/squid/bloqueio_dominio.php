    ...
    var pagefunction = function () {
        ...
        function run_jqgrid_function() {
            ...
            jQuery("#jqgrid").jqGrid({
                datatype: "json",
                url: 'getproxy.php?file=bloqueio_dominio',
                editurl: "editproxy.php?file=bloqueio_dominio",
                colNames: ['Ações', 'Domínio'],
                //datatype : "local",
                mtype: 'GET',
                height: 'auto',
                jsonReader: {
                ...
                gridComplete: function () {
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        ca = "<button class='btn btn-xs btn-default' data-original-title='Cancelar' onclick=\"jQuery('#jqgrid').delRowData('" + cl + "');\"><i class='fa fa-times'></i></button>";
