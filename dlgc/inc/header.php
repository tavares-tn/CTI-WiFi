...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>CTIWifi </title>
...
<!--		 FAVICONS 
		<link rel="shortcut icon" href="<?php echo ASSETS_URL; ?>/img/favicon" type="image/x-icon">
			 ...
			 You can also add different skin classes such as "smart-skin-1", "smart-skin-2" etc...-->
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo">  <img src="<?php echo ASSETS_URL; ?>/img/ctiwifiLogo.png" alt="Logo">  </span>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/?logout=true" title="Sair" data-action="userLogout" data-logout-msg="Tem certeza que deseja sair?"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
