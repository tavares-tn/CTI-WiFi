<html>
<head>
<title>Adicionar Expressão Regular Liberada</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar expressões regulares, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de expressões regulares liberadas.</b></td>';
