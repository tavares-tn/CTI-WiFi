<html>
<head>
<title>Adicionar Dominio Sem senha</title>
...
include_once('../includes/files.inc.php');
	...
	echo "<p class='titulo'>Para Adicionar dominios sem senha, utilize o campo abaixo:</p>";
...
echo '<table class="tabela">';
	...
	echo '<td><b>Lista de Palavras sem Senha</b></td>';

//NOVO METODO PARA CONTAR    
$arquivo = "$palavra_s_senha";
